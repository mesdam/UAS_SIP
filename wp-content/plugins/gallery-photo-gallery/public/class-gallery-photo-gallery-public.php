...
class Gallery_Photo_Gallery_Public {
    ...
    public function ays_show_gallery( $attr ){
        ...
        if ($gpg_resp_width) {
            $responsive_width_height = "$('#ays_grid_row_".$id." img.ays_gallery_image').each(function(){
    ...
    protected function ays_get_gallery_content($gallery, $gallery_options, $gal_lightbox_options, $id){
        ...
        $gallery_img_position_l  = (!isset($gallery_options['gallery_img_position_l']) ||
                                    $gallery_options['gallery_img_position_l'] === null ) ? "center" : $gallery_options['gallery_img_position_l'];
        $gallery_img_position_r  = (!isset($gallery_options['gallery_img_position_r']) ||
                                    $gallery_options['gallery_img_position_r'] === null ) ? "center" : $gallery_options['gallery_img_position_r'];
        $gallery_img_position    = $gallery_img_position_l." ".$gallery_img_position_r;
        ...
        if($show_filter_cat == "on" && $view == "grid"){
            ...
            $show_gallery_filter_cat = "<div class='ays_gallery_filter_cat'>
                                        <a href='javascript:void(0);' class='ays_gpg_category_filter' data-cat='all'>All</a>
                                    ";                                   
        ...
        switch( $view ){
            case "mosaic":
                ...
                foreach ($images_new as $key => $mosaic_column){
                    ...
                    $gallery_view .= "<div class='item withImage ays_mosaic_column_item_".$id."' ".$wh_attr." data-src='" . $images[$key] . "' data-desc='" . $image_titles[$key] ." ". $image_alts[$key] ." ". $image_descs[$key] ."' ".$ays_data_sub_html.">";
            ...
            case "grid":
                ...
                foreach ($images_new as $key => $image){
                    ...
                    $gallery_view .="<div class='ays_grid_column_".$id."' style='width: calc(".($column_width)."% - ".($images_distance)."px);' ".$images_cat_data_id." data-src='" . $images[$key] . "' data-desc='" . $image_titles[$key] ." ". $image_alts[$key] ." ". $image_descs[$key] ."' ".$ays_data_sub_html.">
            ...
            case "masonry":
                ...
                foreach($images_new as $key=>$image){
                    ...
                    $gallery_view .= "<div class='ays_masonry_grid-item ays_masonry_item_".$id."' data-src='" . $images[$key] . "' data-desc='" . $image_titles[$key] ." ". $image_alts[$key] ." ". $image_descs[$key] ."' ".$ays_data_sub_html.">
